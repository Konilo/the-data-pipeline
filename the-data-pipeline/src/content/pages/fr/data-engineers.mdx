...
La collecte de données à partir des systèmes sources est le domaine desData Engineers.
...
Les Data Engineers sont également responsables de la configuration et de la performance de l'infrstructure sur laquelle repose l'équipe Data: le Data Warehouse utilisé par tous les membres de l'équipe, and les outils de business intelligence utilisés par les Data Analysts pour créer des dashboards, par exemple.
