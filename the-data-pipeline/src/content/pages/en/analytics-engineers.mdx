...
summaryRole: "Clean, organize, and document the data and compute key metrics (specific to the downstream needs) so that Data Analysts, Data Scientists, and other end users can analyze it efficiently"
...
The tables stored in a Data Warehouse are often grouped into [successive layers](https://www.databricks.com/glossary/medallion-architecture). The first is called bronze and holds the raw data provided by Data Engineers.
...
- it greatly improves the legibility of the data and facilitates the interconnections between the source systems, from which much value comes from,
- it allows the data warehouse to grow in a healthy manner e.g., more source systems and tables can be integrated rapidly
