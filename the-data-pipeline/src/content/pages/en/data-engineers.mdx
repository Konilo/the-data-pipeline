...
Data Engineers are also responsible for the setup and maintenance of the infrastructure the Data team relies upon: the data wharehouse used by all team mebmbers, and business intelligence tools used by Data Analysts to make dashboards, for instance.
